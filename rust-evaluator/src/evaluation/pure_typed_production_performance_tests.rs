...
#[test]
#[ignore]
fn performance_pure_typed_production_scalar_program() {
    ...
    let scaling_ratio = log_measurement(
        "rustPureTypedScalarProgramProduction",
        FixtureMeasurement {
...
#[test]
#[ignore]
fn performance_pure_typed_production_binding_versions() {
    ...
    let scaling_ratio = log_measurement(
        "rustPureTypedBindingVersionsProduction",
        FixtureMeasurement {
