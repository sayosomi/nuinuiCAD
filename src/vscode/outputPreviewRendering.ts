...
export const outputPreviewPathDataFor = (
  ...
  if (drawable.kind === "offsetLine" || drawable.kind === "joinedPath" || drawable.kind === "polyline") return drawable.segments.map((segment) => pathDataForSegment(segment, project)).join(" ");
