...
const GeometrySelectionSummary = ({ selected }: { selected: ExplorerMockGeometry[] }) => {
  ...
  return (
    <div className="explorer-mock-detail-scroll" data-testid="geometry-selection-summary">
      ...
      <section className="explorer-mock-detail-section"><h4>Modifier coverage</h4><p className="explorer-mock-note"><Layers size={13} aria-hidden="true" />{selected.filter((geometry) => geometry.detail.modifierId).length} of {selected.length} have style provenance.</p></section>
