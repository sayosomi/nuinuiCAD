...
// hash, kind/type/name/nesting structure, or a traversal-order counter. It
// only requires the caller to supply the real mapping and wires it into the
...
// lexicalScopeIndexAdapter.test.ts and test/typedVariablesScopeIndexPerformance.test.ts).
//
