...
describe("queryDslDefinition", () => {
  ...
  it("resolves a geometry value-for property body reference to its immutable binder declaration", () => {
    const source = [
      "nui 1",
  ...
  it("resolves a geometry value-for builtin operand to its immutable binder declaration", () => {
    const source = [
      "nui 1",
