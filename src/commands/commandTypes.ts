...
export type CommandId =
  ...
  | "addOffsetPoint"
  | "commandLineAddOffsetPoint"
  | "addPolarOffsetPoint"
  | "commandLineAddPolarOffsetPoint"
  | "addDivisionPoint"
  | "commandLineAddDivisionPoint"
  | "addLineDivisionPoint"
  | "commandLineAddLineDivisionPoint"
  | "addIntersectionPoint"
  | "commandLineAddIntersectionPoint"
  | "addLineTangentOffsetPoint"
  | "commandLineAddLineTangentOffsetPoint"
  | "addLine"
  | "commandLineAddLine"
  | "addAngleLengthLine"
  | "commandLineAddAngleLengthLine"
  | "addArcLine"
  | "commandLineAddArcLine"
  | "addThreePointArcLine"
  | "commandLineAddThreePointArcLine"
  | "addCornerRadiusArcLine"
  | "commandLineAddCornerRadiusArcLine"
  | "addEdge"
  | "commandLineAddEdge"
  | "addExtendTrim"
  | "commandLineAddExtendTrim"
  | "addBezierCurve"
  | "commandLineAddBezierCurve"
  | "addOffsetLine"
  | "commandLineAddOffsetLine"
  | "addSplitLine"
  | "commandLineAddSplitLine"
  | "addCopyLine"
  | "commandLineAddCopyLine"
  | "addSymmetricCopyLine"
  | "commandLineAddSymmetricCopyLine"
  | "addMove"
  | "commandLineAddMove"
  | "addSymmetricMove"
  | "commandLineAddSymmetricMove"
  | "addImage"
  | "addNumericVariable"
