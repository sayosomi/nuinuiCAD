...
describe("Webview context command aliases", () => {
  ...
  it("defines the exact unique alias-to-canonical command set", () => {
    expect(WEBVIEW_CONTEXT_COMMAND_ALIASES).toEqual([
      ...
      ["nuinuiCAD.webview.showCanvasGrid", "nuinuiCAD.toggleCanvasGrid"],
      ["nuinuiCAD.webview.hideCanvasGrid", "nuinuiCAD.toggleCanvasGrid"],
      ["nuinuiCAD.webview.canvasGridSettings", "nuinuiCAD.configureCanvasGrid"],
