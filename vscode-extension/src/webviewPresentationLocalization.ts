...
export const webviewPresentationTranslationCatalog = {
  ...
  "canvas.ribbon.viewport": { en: "Viewport", ja: "表示範囲" },
  "canvas.ribbon.display": { en: "Display", ja: "表示" },
  "canvas.ribbon.grid": { en: "Grid", ja: "グリッド" },
  "canvas.ribbon.points": { en: "Points", ja: "点" },
  "canvas.ribbon.pointNames": { en: "Point Names", ja: "点名" },
  "canvas.ribbon.geometryNames": { en: "Geometry Names", ja: "図形名" },
  ...
  "canvas.ribbon.command.zoomOutCanvas.label": { en: "Zoom Out", ja: "縮小" },
  "canvas.ribbon.command.zoomOutCanvas.description": { en: "Zoom the Canvas out.", ja: "Canvasを縮小します。" },
  "canvas.ribbon.command.zoomInCanvas.label": { en: "Zoom In", ja: "拡大" },
  "canvas.ribbon.command.zoomInCanvas.description": { en: "Zoom the Canvas in.", ja: "Canvasを拡大します。" },
  ...
  "canvas.ribbon.command.toggleCanvasGrid.label": { en: "Grid", ja: "グリッド" },
  "canvas.ribbon.command.toggleCanvasGrid.description": { en: "Show or hide the Canvas grid.", ja: "Canvasのグリッドを表示または非表示にします。" },
  "canvas.ribbon.command.configureCanvasGrid.label": { en: "Grid Settings", ja: "グリッド設定" },
  "canvas.ribbon.command.configureCanvasGrid.description": { en: "Configure Canvas grid visibility, spacing, and major interval.", ja: "Canvasグリッドの表示、間隔、主線間隔を設定します。" },
  ...
  "canvas.zoomPercent.description": { en: "Current Canvas zoom.", ja: "現在のCanvasズームです。" },
  ...
  "output.ribbon.zoomOut": { en: "Zoom out", ja: "縮小" },
  "output.ribbon.zoomIn": { en: "Zoom in", ja: "拡大" },
  ...
  "modulePreview.action.previewValues": { en: "Preview Values...", ja: "値をプレビュー..." },
  "modulePreview.action.insertInstance": { en: "Insert Instance", ja: "インスタンスを挿入" },
  "modulePreview.valueSummary.ariaLabel": { en: "Current Module Preview parameter values", ja: "現在のModule Previewパラメータ値" },
  "modulePreview.valueSummary.context": { en: "Context", ja: "コンテキスト" },
  "modulePreview.valueSummary.target": { en: "Target", ja: "対象" },
  "modulePreview.valueSummary.omittedOptional": { en: "omitted (optional)", ja: "省略（任意）" },
  "modulePreview.valueSummary.omittedDefaulted": { en: "omitted (default: {default})", ja: "省略（デフォルト: {default}）" },
