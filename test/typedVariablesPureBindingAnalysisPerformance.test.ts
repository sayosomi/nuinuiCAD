...
const [SMALL_SIZE, LARGE_SIZE] = PURE_TYPED_BINDING_SIZES;
...
const prepare = (bindingCount: number) => {
  const fixture = buildPureTypedBindingSource(bindingCount);
  return {
    ...fixture,
...
describePerformanceGates("pure nui 1 binding analysis performance", () => {
  it("gates 250/1000 typed const/let binding analysis without runtime evaluation", () => {
    ...
    logPerformanceGateMeasurement("pureTypedBindingAnalysis", measurement);
