...
| [phase-1c-text-canonical.md](phase-1c-text-canonical.md) | 正準反転: sourceTextが正・統合Undo・選択のUIストア移動 | 1b |
| [phase-1d-nui-format.md](phase-1d-nui-format.md) | `.nui` 保存/読込+レガシーインポータ | 1c |
